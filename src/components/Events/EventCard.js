...
const AnimateCard = ({ event: { eventName, imagePath, smallDesc, bigDesc, dates, prizes, reg } }) => {
	return (
					...
					<div className='details'>
						...
						<div className='details-content'>
							...
							<div className='center l-flex c-white'>
								<div {...to('description')}>
									<div className='d-flex flex-row-reverse' onClick={() => go(0)}>
										<IoCloseSharp />
									</div>
									<div className='row'>
										...
										<div className='col-lg-6 col-md-6 col-sm-12 col-12'>
											...
											<p className='desc-text'>₹100 - Solo</p>
	...
	return (
		...
		<div className='row mt-4'>
			{Event_List.map((eventdet) => (
				<div
					key={eventdet.id}
					className='col-lg-4 col-md-6 col-sm-12 col-12 mt-5'
