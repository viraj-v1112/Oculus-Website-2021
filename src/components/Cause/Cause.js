    ...
    <div className='back-app'>
      <div className='container laptop-cause'>
        ...
        <div className='row py-5 px-0'>
          <div className='col col-lg-6 col-md-6 col-sm-12 col-12 px-3 align-self-center'>
            <img
              src={CauseImage}
          ...
          <div className='col col-lg-6 col-md-6 col-sm-12 col-12 text-bg align-self-center'>
            <p>
